...
class TestMerge:
    ...
    def test_outer_join(self, idadf_iris, idadf_iris2):
        ida_nzpyida_join = nzpyida.merge(idadf_iris, idadf_iris2, how='outer', left_index=True, right_on='index')
    ...
    def test_only_right_on(self, idadf_iris, idadf_iris2):
        with pytest.raises(ValueError) as e:
            nzpyida.merge(idadf_iris, idadf_iris2, right_on="index")
            assert str(e) == 'Must pass "left_on" OR "left_index'
    ...
    def test_both_left_on_and_indexer(self, idadf_iris, idadf_iris2):
        with pytest.raises(ValueError) as e:
            nzpyida.merge(idadf_iris, idadf_iris2, left_on="index", left_index=True, right_index=True)
