...
class LinearRegression:
    ...
    def fit(self, in_df: IdaDataFrame, id_column: str, target_column: str, in_column: str=None,
        ...
        """
        Create a linear regression model based on provided data and store it in a database.
        """
        ...
        try:
            self.idadb.ida_query(f'call NZA..LINEAR_REGRESSION(\'{params}\')')
        finally:
            if need_delete:
    ...
    def predict(self, in_df: IdaDataFrame, out_table: str=None, id_column: str=None) -> IdaDataFrame:
        ...
        try:
            self.idadb.ida_query(f'call NZA..PREDICT_LINEAR_REGRESSION(\'{params}\')')
        finally:
            if need_delete:
                self.idadb.drop_view(temp_view_name)
